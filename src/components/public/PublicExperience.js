...
// TODO: replace remaining modals by Material UI Dialog
...
import FreelancerExperienceEdit from '../freelancer/FreelancerExperienceEdit';
...
class PublicExperience extends Component {
  ...
  render() {
    ...
    const { showCert, dialog } = this.state;
                ...
                <div className={classes.experienceButtons}>
                  ...
                  {/* Edit experience draft */}
                  {
                    (
                      ...
                      <Button
                        onClick={() => this.openEditExperienceDialog(experience)}
                        className={classNames(classes.experienceButton, classes.experienceBlackButton)}
                      >
...
export default compose(withStyles(styles), connect(mapStateToProps))(PublicExperience);
