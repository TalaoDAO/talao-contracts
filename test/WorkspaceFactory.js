...
// Sample data.
const email = '0x6775696c6c61756d652e64757665617540676d61696c2e636f6d'
const emailAscii = 'guillaume.duveau@gmail.com'
...
contract('Workspace Factory', async (accounts) => {
  ...
  it('Workspace 1 should have User1\'s email', async() =>  {
    const result = await workspace.getClaim(web3.utils.soliditySha3(user1, erc735js.asciiToTopic('email')))
    assert.equal(web3.utils.hexToAscii(result[4]), emailAscii)
  })
