...
contract('Tokenized', async (accounts) => {
  ...
  it('Should deploy keyHolderLibrary, link it in ClaimHolderLibrary, deploy claimHolderLibrary, link both libs in Tokenized', async() => {
    ...
    await Tokenized.link(KeyHolderLibrary, keyHolderLibrary.address);
    await Tokenized.link(ClaimHolderLibrary, claimHolderLibrary.address);
  });
